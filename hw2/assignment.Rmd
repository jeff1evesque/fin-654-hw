...
Finally, quantile regression was used to determine whether inter-market transactions can affect successive transactions in a given market. The `tau` parameter defines the desired quantile level.
